...
One session record per established channel. A given account may hold many concurrent sessions — including multiple concurrent sessions with the same counterparty against the same advertisement. There is no cap in MVP; limits are post-MVP (see [../../future/roadmap/resource-limits.md](../../future/roadmap/resource-limits.md)).
