...
Metrics remain deferred to post-MVP work per [../../future/roadmap/metrics.md](../../future/roadmap/metrics.md).
...
These items remain part of the broader architecture and are tracked in [../../future/roadmap/](../../future/roadmap/). Per-concept specs defer to this boundary rather than enumerating it again.
