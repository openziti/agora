...
func unpackListAuditEventsParams(packed middleware.Parameters) (params ListAuditEventsParams) {
	{
		key := middleware.ParameterKey{
			Name: "eventType",
			In:   "query",
		...
		if v, ok := packed[key]; ok {
			params.EventType = v.([]AuditEventType)
		}
	}
	{
		key := middleware.ParameterKey{
		...
		if v, ok := packed[key]; ok {
			params.WorkgroupId = v.(OptString)
		}
	}
	{
		key := middleware.ParameterKey{
...
func decodeListAuditEventsParams(args [0]string, argsEscaped bool, r *http.Request) (params ListAuditEventsParams, _ error) {
	q := uri.NewQueryDecoder(r.URL.Query())
		...
		if err := q.HasParam(cfg); err == nil {
			if err := q.DecodeParam(cfg, func(d uri.Decoder) error {
				return d.DecodeArray(func(d uri.Decoder) error {
					var paramsDotEventTypeVal AuditEventType
					if err := func() error {
						val, err := d.DecodeValue()
						if err != nil {
							return err
						...
						paramsDotEventTypeVal = AuditEventType(c)
						return nil
					}(); err != nil {
						return err
					}
			...
			if err := func() error {
				...
				for i, elem := range params.EventType {
					if err := func() error {
	...
	if err := func() error {
		...
		if err := q.HasParam(cfg); err == nil {
			if err := q.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotWorkgroupIdVal string
				if err := func() error {
					val, err := d.DecodeValue()
					if err != nil {
						return err
					...
					paramsDotWorkgroupIdVal = c
					return nil
				}(); err != nil {
					return err
				}
				params.WorkgroupId.SetTo(paramsDotWorkgroupIdVal)
				return nil
			}); err != nil {
				return err
			}
			if err := func() error {
				if value, ok := params.WorkgroupId.Get(); ok {
					if err := func() error {
						if err := (validate.String{
							MinLength:    0,
							MinLengthSet: false,
	...
	if err := func() error {
		...
		if err := q.HasParam(cfg); err == nil {
			...
			if err := func() error {
				if value, ok := params.AccountId.Get(); ok {
					if err := func() error {
						if err := (validate.String{
							MinLength:    0,
							MinLengthSet: false,
...
func unpackListSessionsParams(packed middleware.Parameters) (params ListSessionsParams) {
	...
	}
	{
		...
		if v, ok := packed[key]; ok {
			params.Sort = v.(OptListSessionsSort)
		}
	}
	{
		key := middleware.ParameterKey{
...
func decodeListSessionsParams(args [0]string, argsEscaped bool, r *http.Request) (params ListSessionsParams, _ error) {
	...
	if err := func() error {
		...
		if err := q.HasParam(cfg); err == nil {
			if err := q.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotSortVal ListSessionsSort
				if err := func() error {
					val, err := d.DecodeValue()
					if err != nil {
						return err
					...
					paramsDotSortVal = ListSessionsSort(c)
					return nil
				}(); err != nil {
					return err
				}
